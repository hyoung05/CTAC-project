...
| ------------------ | ---------- | ---------- | ---------- | --------- |
| LogisticRegression | 0.8639     | 0.7017     | 0.5978     | 0.6436    |
| LR (TF-IDF)        | 0.9078     | 0.7003     | 0.9706     | 0.8136    |
| Decision Tree      | 0.891      | 0.7052     | 0.8137     | 0.7551    |
| RandomForest       | 0.8998     | 0.701      | 0.9006     | 0.7879    |
| **LightGBM**       | **0.9021** | **0.7001** | **0.9228** | **0.796** |
